...
public class Otherlib_discussionroom_socialscience {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Otherlib_discussionroom_socialscience window = new Otherlib_discussionroom_socialscience();
	 ...
	 */
	public Otherlib_discussionroom_socialscience() {
		initialize();
	}
