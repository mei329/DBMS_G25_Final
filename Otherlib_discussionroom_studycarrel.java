...
public class Otherlib_discussionroom_studycarrel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Otherlib_discussionroom_studycarrel window = new Otherlib_discussionroom_studycarrel();
	 ...
	 */
	public Otherlib_discussionroom_studycarrel() {
		initialize();
	}
