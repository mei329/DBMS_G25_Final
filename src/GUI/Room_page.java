...
public class Room_page extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Room_page window = new Room_page(109405094l);
	...
	private void initialize() {
		...
		btnNewButton.setBounds(270, 150, 124, 50);
		frame.getContentPane().add(btnNewButton);

		JButton btnNewButton_1 = new JButton("總圖/商圖/綜圖");
		btnNewButton_1.setFont(new Font("Waseem", Font.PLAIN, 15));
		btnNewButton_1.setForeground(new Color(115, 121, 59));
		btnNewButton_1.setBounds(50, 150, 140, 50);
		...
		JButton btnNewButton_4 = new JButton("快速預約");
		...
		btnNewButton_4.setBounds(160, 235, 124, 50);
