...
public class Dah_Hsian_discussion_room_4F {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Dah_Hsian_discussion_room_4F window = new Dah_Hsian_discussion_room_4F(109405094);
	...
	private void initialize() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Booking_page_1 bp1 = new Booking_page_1(studentId);
		...
		btnNewButton_22.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (n == 0) {
					...
					sids.add(studentId);
					if (o.createRoomOrder(401, "T", odate, bStart, bEnd, sids)) {
						Dah_Hsian_discussion_room_4F_2 dh2 = new Dah_Hsian_discussion_room_4F_2(studentId);
						frame.setVisible(false);
					} else {
						JOptionPane.showMessageDialog(frame, "預約失敗...");
					}
				}
